...
import (
	...
	"github.com/ro-oliveira95/letsgo-snippetbox/internal/validator"
)
...
func (app *application) snippetView(w http.ResponseWriter, r *http.Request) {
	...
	// Fetch snippet in DB and populate template data
...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
	...
	// Persist new snippet in database
	...
	// Push success flash message and redirect the user to the newly snippet page
...
func (app *application) userLogin(w http.ResponseWriter, r *http.Request) {
	...
	// Renewing session ID to prevent session fixation attack
	if err = app.sessionManager.RenewToken(r.Context()); err != nil {
		app.serverError(w, err)
		return
	}

	// Update session and send user to Home
